...
Replace this section with the supported versions for `fetchfreeze`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `fetchfreeze` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in fetchfreeze.
